...
class Course(models.Model):
    ...
    creator = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="Создатель", related_name="created_courses")
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name="owned_courses", verbose_name="Владелец")
...
class Lesson(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name="owned_lessons", verbose_name="Владелец")  # Новое поле
